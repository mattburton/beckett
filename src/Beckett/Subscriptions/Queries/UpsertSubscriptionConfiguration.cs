...
) : IPostgresDatabaseQuery<int>
{
    public async Task<int> Execute(NpgsqlCommand command, CancellationToken cancellationToken)
    {
        ...
        if (messageTypeNames is { Length: > 0 })
        {
        ...
        updateSubscriptionCommand.Parameters.Add(new NpgsqlParameter { NpgsqlDbType = NpgsqlDbType.Text });
        updateSubscriptionCommand.Parameters.Add(
            new NpgsqlParameter { NpgsqlDbType = NpgsqlDbType.Text, IsNullable = true }
        );
        updateSubscriptionCommand.Parameters.Add(
            new NpgsqlParameter { NpgsqlDbType = NpgsqlDbType.Text, IsNullable = true }
        );
        ...
        if (messageTypeNames is { Length: > 0 })
        {
            ...
            insertTypesCommand.Parameters.Add(new NpgsqlParameter { NpgsqlDbType = NpgsqlDbType.Text });
            insertTypesCommand.Parameters.Add(
                new NpgsqlParameter { NpgsqlDbType = NpgsqlDbType.Array | NpgsqlDbType.Text }
            );
