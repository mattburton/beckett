...
CREATE INDEX IF NOT EXISTS ix_checkpoints_to_process
  ON __schema__.checkpoints (group_name, name, process_at)
...
CREATE INDEX IF NOT EXISTS ix_checkpoints_metrics ON __schema__.checkpoints (group_name, name, status, lagging);
