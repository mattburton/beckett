...
public class CommandOptions<TState> : CommandOptions
{
    /// <summary>
    /// Override the state that will be passed to the command when executing. This allows you to manually construct the
    /// state as necessary - reading multiple streams, augmenting the model with information retrieved from a database
    /// query, etc...
    /// </summary>
