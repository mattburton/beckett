...
public interface ISubscriptionSettingsBuilder
{
    /// <summary>
    ...
    ISubscriptionSettingsBuilder HandlerName(string name);
    ...
    /// <returns>Builder to further configure the subscription</returns>
    ISubscriptionSettingsBuilder StartingPosition(StartingPosition startingPosition);
    ...
    /// <returns>Builder to further configure the subscription</returns>
    ISubscriptionSettingsBuilder MaxRetryCount(int maxRetryCount);
    ...
    /// <returns>Builder to further configure the subscription</returns>
    ISubscriptionSettingsBuilder MaxRetryCount<TException>(int maxRetryCount) where TException : Exception;
    ...
    /// <returns>Builder to further configure the subscription</returns>
    ISubscriptionSettingsBuilder Priority(int priority);
}
