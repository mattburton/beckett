...
{
    public class Handler(NpgsqlDataSource dataSource) : IQueryHandler<UserLookupQuery, UserLookupReadModel?>
    {
        public async Task<UserLookupReadModel?> Handle(UserLookupQuery query, CancellationToken cancellationToken)
        {
